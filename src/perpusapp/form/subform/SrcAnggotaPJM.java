 ...
 * @author Fathi
 */
public class SrcAnggotaPJM extends javax.swing.JDialog {
     ...
     */
    public SrcAnggotaPJM(Frame parent, String search_Anggota, boolean modal) {
        super(parent, modal);
        initComponents();
        customInit();
        showTable();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField2.getText().isEmpty()) {
            app.mainForm.pjm.setAnggota(jTextField2.getText(), jTextField3.getText());
            app.mainForm.pjm.enableBuku();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SrcAnggotaPJM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SrcAnggotaPJM dialog = new SrcAnggotaPJM(new javax.swing.JFrame(), "Search Anggota", true);
